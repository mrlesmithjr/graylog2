...
wget https://packages.graylog2.org/releases/graylog2-server/graylog-1.3.0.tgz
wget https://packages.graylog2.org/releases/graylog2-web-interface/graylog-web-interface-1.3.0.tgz
...
ln -s graylog2-server-1.3*/ graylog2-server
...
cd /opt/
ln -s graylog2-web-interface-1.9*/ graylog2-web-interface
