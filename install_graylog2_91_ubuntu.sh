...
wget http://packages.graylog2.org/releases/graylog2-server/graylog2-server-0.91.3.tgz
wget http://packages.graylog2.org/releases/graylog2-web-interface/graylog2-web-interface-0.91.3.tgz
# Extract files
...
echo "Updating graylog2.conf, rsyslog.conf, and graylog2-web-interface.conf"
