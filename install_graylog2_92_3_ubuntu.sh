...
# Updated 12/31/14 by zstarer for new ES version & Graylog0.92.3 support
...
# Install Pre-Reqs
# apt-get -y install git curl libcurl4-openssl-dev libapr1-dev libcurl4-openssl-dev libapr1-dev build-essential openssl libreadline6 libreadline6-dev curl git-core zlib1g zlib1g-dev
sudo apt-get -y install libssl-dev libyaml-dev libsqlite3-dev sqlite3 libxml2-dev libxslt-dev autoconf libc6-dev ncurses-dev automake libtool bison subversion pkg-config python-software-properties software-properties-common openjdk-7-jre pwgen git curl build-essential openjdk-7-jre pwgen wget netcat
...
rm /opt/elasticsearch-1.3.4.deb
