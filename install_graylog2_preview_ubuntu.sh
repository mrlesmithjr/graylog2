...
wget https://github.com/Graylog2/graylog2-server/releases/download/0.20.0-rc.2/graylog2-server-0.20.0-rc.2.tgz
...
wget https://github.com/Graylog2/graylog2-web-interface/releases/download/0.20.0-rc.2/graylog2-web-interface-0.20.0-rc.2.tgz
